...
public class AttackManager {
     ...
     Attack thunderbolt = new Attack("Rayo", 90, 100);
     Attack ironTail = new Attack("Cola ferrea", 100, 75);
     Attack hyperBeam = new Attack("Hiperrayo", 150, 90);
     Attack solarBeam = new Attack("Rayo solar", 120, 100);
     Attack iceBeam = new Attack("Rayo hiela", 90, 100);
     ...
     Attack airSlash = new Attack("Corte aereo", 75, 95);
     Attack brickBreak = new Attack("Abocajarro", 75, 100);
     Attack bugBuzz = new Attack("Estoicismo", 90, 100);
}
